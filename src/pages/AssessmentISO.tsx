        ...
        <div className="max-w-4xl mx-auto">
          <Card className="mb-6 shadow-medium">
            <CardHeader>
              ...
              <CardDescription>
                Evalúa cada dominio de control según el nivel de madurez de tu organización
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-2">
                {maturityLevels.map((level) => (
                  <div key={level.id} className="flex gap-2">
                    <span className="font-semibold text-primary">Nivel {level.level}:</span>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-5 gap-2">
                      {maturityLevels.map((level) => (
                        <Button
                          key={level.id}
                          variant={selectedLevels[domain.id] === level.id ? "default" : "outline"}
                          className="w-full"
                          onClick={() =>
                  ...
                  {selectedLevels[domain.id] && (
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Describe las evidencias o comentarios sobre este dominio..."
