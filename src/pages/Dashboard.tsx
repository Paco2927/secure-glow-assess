    ...
    <div className="min-h-screen gradient-subtle">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img
            id="imagenMostrada"
            src="https://www.google.com/url?sa=i&url=https%3A%2F%2Ftechsecureai.com%2F&psig=AOvVaw0n8z37WDlgJtkMCJN52CEM&ust=1760629015862000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCODAtqrEppADFQAAAAAdAAAAABAE/400x300"
          />
        </div>
