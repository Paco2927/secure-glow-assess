-- Drop all possible policies (including old and new ones)
...
DROP POLICY IF EXISTS "Users and org members can create assessment results" ON assessment_results;
DROP POLICY IF EXISTS "Users and org members can update assessment results" ON assessment_results;
